package com.app.merbng.mycodelibs.A_MagicFloatView.exp1Barrang;
...
/**气球上升的效果
 * https://github.com/helloyingying/Barrage
 */
public class BarrangActivity extends BaseActivity implements View.OnClickListener{
    Barrage barrage;
    int[] colors = new int[]{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barrang);
        barrage = new Barrage(this, (BarrageView) findViewById(R.id.barrage));
        coinBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.github);
        balloonBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ebo);
    }
    @Override
