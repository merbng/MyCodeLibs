...
public class ShowTipsView extends RelativeLayout {
    ...
    public void show(final Activity activity) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Animation fadeInAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.guide_fade_in);
    ...
    private void createViews() {
        ...
        btn_close.setId(R.id.int4375Id);
    ...
    public void setButtonTextMargin(int rightMargin, int bottomMargin) {
