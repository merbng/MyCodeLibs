 ...
 * https://github.com/AndroidStudy2015/BezierCurveAnimater
 */
public class BeziercurveanimaterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beziercurveanimater);
        initView();
        initImg();
        ...
        bitmapList.add(BitmapFactory.decodeResource(getResources(), R.drawable.ebo));
        bitmapList.add(BitmapFactory.decodeResource(getResources(), R.drawable.ecn));
        bitmapList.add(BitmapFactory.decodeResource(getResources(), R.drawable.eer));
    }
