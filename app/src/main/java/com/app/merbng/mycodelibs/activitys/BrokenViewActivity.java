...
public class BrokenViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_broken_view);
    ...
    private void initView() {
        ...
        myView = (BrokenView) findViewById(R.id.demo_myview);
        button = (Button) findViewById(R.id.demo_button);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(mContext, "Button onClick", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void refreshDate() {
        ...
        listView.setAdapter(new SampleAdapter(mContext, android.R.layout.simple_list_item_1, items));
