...
import com.app.merbng.mycodelibs.A_loadProgress.bean.DifferentInfo;
...
public class DifferentActivity extends AppCompatActivity {
	...
	private void initData() {
		...
		// TODO: 2016/11/4 确实adapter 
//		mListView.setAdapter(new SimpleAdapter(this,info5, R.layout.item_list2, differents));
	}
}
