...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = MyCodeLibApplication.getmContext().getCacheDir().getAbsolutePath();
    ...
    private Drawable createPicPlaceholder() {
        Drawable drawable;
        int color = R.color.bg_white;
        drawable = new ColorDrawable(MyCodeLibApplication.getmContext().getResources().getColor(color));
