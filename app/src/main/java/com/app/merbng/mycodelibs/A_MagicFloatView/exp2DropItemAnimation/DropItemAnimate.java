...
public class DropItemAnimate {
    ...
    private int[] defaultItemsId = {R.drawable.eft, R.drawable.eep, R.drawable.eco};
    ...
    void initView() {
        ...
        random = new Random();
        mLayoutParams = new ViewGroup.LayoutParams(DensityUtil.dip2px(mContext, 30), DensityUtil.dip2px(mContext, 30));
    }
